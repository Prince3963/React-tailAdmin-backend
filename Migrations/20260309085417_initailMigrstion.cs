...
namespace MyDummyAPI.Migrations
{
    /// <inheritdoc />
    public partial class initailMigrstion : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousCTC = table.Column<int>(type: "int", nullable: true),
                    ...
                    TakenLeave = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Month = table.Column<int>(type: "int", nullable: false),
                    Year = table.Column<int>(type: "int", nullable: false),
                    ExpectedAmount = table.Column<int>(type: "int", precision: 18, scale: 2, nullable: false),
                    ActualAmount = table.Column<int>(type: "int", precision: 18, scale: 2, nullable: false),
                    SettlementAmount = table.Column<int>(type: "int", precision: 18, scale: 2, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ProcessedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    TotalExpense = table.Column<int>(type: "int", precision: 18, scale: 2, nullable: false),
                    GrossProfit = table.Column<int>(type: "int", precision: 18, scale: 2, nullable: false),
                    NetProfit = table.Column<int>(type: "int", precision: 18, scale: 2, nullable: false),
                    IsSetteled = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectValue = table.Column<int>(type: "int", nullable: false),
                    ...
                    ManagerEmail = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ManagerContact = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    LeaveApplyWay = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ClientManagerName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ClientManagerEmail = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ClientManagerContact = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    IsSmooth = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    MobileNumberUsed = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
